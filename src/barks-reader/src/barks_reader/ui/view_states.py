...
_NODE_TEXT_TO_VIEW_STATE_MAP: dict[str, ViewStates] = {
    ...
    TITLE_SEARCH_NODE_TEXT: ViewStates.ON_TITLE_SEARCH_NODE,
    TAG_SEARCH_NODE_TEXT: ViewStates.ON_TAG_SEARCH_NODE,
    WORD_SEARCH_NODE_TEXT: ViewStates.ON_WORD_SEARCH_NODE,
    APPENDIX_NODE_TEXT: ViewStates.ON_APPENDIX_NODE,
    APPENDIX_RICH_TOMMASO_ON_COLORING_BARKS_TEXT: ViewStates.ON_APPENDIX_RICH_TOMMASO_ON_COLORING_BARKS_NODE,  # noqa: E501
    ...
    APPENDIX_STATISTICS_NODE_TEXT: ViewStates.ON_APPENDIX_STATISTICS_NODE,
    ...
    "N/A" + ViewStates.ON_INDEX_SPEECH_WORDS_NODE.name: ViewStates.ON_INDEX_SPEECH_WORDS_NODE,
    INDEX_NAMES_TEXT: ViewStates.ON_INDEX_NAMES_NODE,
    INDEX_LOCATIONS_TEXT: ViewStates.ON_INDEX_LOCATIONS_NODE,
...
_ARTICLE_VIEW_STATE_TO_TITLE_MAP = {
    ViewStates.ON_APPENDIX_RICH_TOMMASO_ON_COLORING_BARKS_NODE: Titles.RICH_TOMMASO___ON_COLORING_BARKS,  # noqa: E501
