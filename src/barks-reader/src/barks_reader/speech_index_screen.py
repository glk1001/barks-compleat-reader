...
MAX_TITLE_LEN = 45
SPEECH_INDEX_SCREEN_KV_FILE = Path(__file__).with_suffix(".kv")
...
class SpeechIndexScreen(FloatLayout):
    ...
    def on_is_visible(self, _instance: SpeechIndexScreen, value: bool) -> None:
