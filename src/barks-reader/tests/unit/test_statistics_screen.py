...
from barks_reader.ui.statistics_screen import StatisticsScreen, StatMenuButton
...
def screen(statistics_dir: Path) -> Generator[StatisticsScreen]:
    ...
    with (
        ...
        patch.object(statistics_screen_module, "Factory") as mock_factory,
    ):
        mock_ids = {
        ...
        mock_factory.WordStatDropDown.return_value = mock_dropdown
