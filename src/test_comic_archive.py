...
from fantagraphics_volumes import FantagraphicsArchive, get_fantagraphics_archive_dict

ARCHIVE_ROOT = "/mnt/2tb_drive/Books/Carl Barks/Fantagraphics Volumes"
OVERRIDE_ROOT = "/mnt/2tb_drive/Books/Carl Barks/Fantagraphics Volumes Overrides"
...
if __name__ == "__main__":
    ...
    fanta_archive_dict = get_fantagraphics_archive_dict(ARCHIVE_ROOT, OVERRIDE_ROOT, vol_list)

    print()
    print(f'Archive Root: "{ARCHIVE_ROOT}"')

    for fanta_vol in vol_list:
        fanta_archive = fanta_archive_dict[fanta_vol]
