...
SERIES_INFO: list[FantaSeriesInfo] = [
    ...
    FantaSeriesInfo(Bt.FANTASTIC_RIVER_RACE_THE, RTOM, SERIES_USA, FANTA_16),
    ...
    FantaSeriesInfo(Bt.FORBIDIUM_MONEY_BIN_THE, EROS, SERIES_USA, FANTA_22),
    ...
    FantaSeriesInfo(Bt.STATUS_SEEKER_THE, GLEA, SERIES_USA, FANTA_30),
    FantaSeriesInfo(Bt.CASE_OF_THE_STICKY_MONEY_THE, DIGI, SERIES_USA, FANTA_30),
    FantaSeriesInfo(Bt.FOR_OLD_DIMES_SAKE, SLEA, SERIES_USA, FANTA_30),
    FantaSeriesInfo(Bt.CROWN_OF_THE_MAYAS, BIGD, SERIES_USA, FANTA_30),
    FantaSeriesInfo(Bt.ISLE_OF_GOLDEN_GEESE, DIGI, SERIES_USA, FANTA_30),
    FantaSeriesInfo(Bt.LOST_BENEATH_THE_SEA, GLEA, SERIES_USA, FANTA_30),
    FantaSeriesInfo(Bt.THRIFTY_SPENDTHRIFT_THE, BIGD, SERIES_USA, FANTA_30),
    FantaSeriesInfo(Bt.MANY_FACES_OF_MAGICA_DE_SPELL_THE, GLEA, SERIES_USA, FANTA_30),
    # US SHORTS
    ...
    FantaSeriesInfo(Bt.LEMONADE_FLING_THE, BIGD, SERIES_USS, FANTA_30),
    # GG
    ...
    FantaSeriesInfo(Bt.SNOW_DUSTER, GLEA, SERIES_GG, FANTA_30),
    FantaSeriesInfo(Bt.HELPERS_HELPING_HAND_A, DIGI, SERIES_GG, FANTA_30),
    FantaSeriesInfo(Bt.MAN_VERSUS_MACHINE, GLEA, SERIES_GG, FANTA_30),
    FantaSeriesInfo(Bt.JONAH_GYRO, SLEA, SERIES_GG, FANTA_30),
    # WDCS
    ...
    FantaSeriesInfo(Bt.DONALDS_GRANDMA_DUCK, RTOM, SERIES_MISC, FANTA_09),
    FantaSeriesInfo(Bt.CAMP_COUNSELOR, RTOM, SERIES_MISC, FANTA_09),
    ...
    FantaSeriesInfo(Bt.EAGLE_SAVERS, MARJ, SERIES_MISC, FANTA_29),
    FantaSeriesInfo(Bt.STORM_DANCERS, EGMONT, SERIES_MISC, FANTA_29),
    FantaSeriesInfo(Bt.HOUND_OF_THE_MOANING_HILLS, SLEA, SERIES_MISC, FANTA_29),
    FantaSeriesInfo(Bt.DAY_THE_MOUNTAIN_SHOOK_THE, SUMH, SERIES_MISC, FANTA_29),
    FantaSeriesInfo(Bt.INVISIBLE_INTRUDER_THE, BIGD, SERIES_MISC, FANTA_30),
    FantaSeriesInfo(Bt.TRAVEL_TIGHTWAD_THE, BIGD, SERIES_MISC, FANTA_30),
    # Articles
    FantaSeriesInfo(Bt.GEORGE_LUCAS___AN_APPRECIATION, "", SERIES_EXTRAS, FANTA_01),
    FantaSeriesInfo(Bt.RICH_TOMMASO___ON_COLORING_BARKS, "", SERIES_EXTRAS, FANTA_07),
