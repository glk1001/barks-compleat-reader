...
NUM_TITLES = 643 + 4  # +4 for articles
...
BARKS_TITLE_INFO: list[ComicBookInfo] = [
    ...
    ComicBookInfo(Titles.CLOTHES_MAKE_THE_DUCK, False, Issues.US, 32, 12, 1960, 17, 5, 1960),
    ComicBookInfo(Titles.THAT_SMALL_FEELING, False, Issues.US, 32, 12, 1960, 13, 6, 1960),
    ...
    ComicBookInfo(Titles.THRIFT_GIFT_A, False, Issues.US, 32, 12, 1960, 18, 7, 1960),
    ...
    ComicBookInfo(Titles.YOU_CANT_WIN, False, Issues.US, 33, 3, 1961, 15, 8, 1960),
    ComicBookInfo(Titles.BILLIONS_IN_THE_HOLE, False, Issues.US, 33, 3, 1961, 3, 9, 1960),
    ComicBookInfo(Titles.BONGO_ON_THE_CONGO, False, Issues.US, 33, 3, 1961, 12, 9, 1960),
    ...
    ComicBookInfo(Titles.CHUGWAGON_DERBY, False, Issues.US, 34, 6, 1961, 16, 11, 1960),
    ComicBookInfo(Titles.MYTHTIC_MYSTERY, False, Issues.US, 34, 6, 1961, 10, 12, 1960),
    ComicBookInfo(Titles.WILY_RIVAL, False, Issues.US, 34, 6, 1961, 10, 12, 1960),
    ...
    ComicBookInfo(Titles.GOLDEN_NUGGET_BOAT_THE, False, Issues.US, 35, 9, 1961, 16, 2, 1961),
    ComicBookInfo(Titles.FAST_AWAY_CASTAWAY, False, Issues.US, 35, 9, 1961, 24, 2, 1961),
    ComicBookInfo(Titles.GIFT_LION, False, Issues.US, 35, 9, 1961, 24, 2, 1961),
    ...
    ComicBookInfo(Titles.MIDAS_TOUCH_THE, False, Issues.US, 36, 12, 1961, 17, 4, 1961),
    ComicBookInfo(Titles.MONEY_BAG_GOAT, False, Issues.US, 36, 12, 1961, 3, 5, 1961),
    ComicBookInfo(Titles.DUCKBURGS_DAY_OF_PERIL, False, Issues.US, 36, 12, 1961, 3, 5, 1961),
