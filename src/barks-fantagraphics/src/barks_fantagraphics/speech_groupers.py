    ...
    def get_speech_page_groups(self, title: Titles) -> list[SpeechPageGroup]:
        ...
        for srce_page, dest_page in srce_dest_map.items():
            for ocr_index in OcrTypes:
                ...
                speech_page_groups.append(speech_page_group_with_json.speech_page_group)
...
def get_speech_page_group_with_json(
    ...
    return SpeechPageGroupWithJson(
        speech_page_group, speech_groups_json, ocr_prelim_groups_json_file
    )
...
def _has_speech_page_group_changed(speech_page_group_with_json: SpeechPageGroupWithJson) -> bool:
    speech_page_group = speech_page_group_with_json.speech_page_group
    speech_page_json = speech_page_group_with_json.speech_page_json
...
def _save_speech_page_group(
    speech_page_group_with_json: SpeechPageGroupWithJson,
    to_file: Path | None,
    ...
    if need_to_save:
        if to_file is None:
            to_file = speech_page_group_with_json.ocr_prelim_groups_json_file
        if backup_file:
