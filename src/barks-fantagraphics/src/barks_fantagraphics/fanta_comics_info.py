...
SERIES_INFO: list[FantaSeriesInfo] = [
    ...
    FantaSeriesInfo(Bt.MAGGIE_THOMPSON___COMICS_READERS_FIND_COMIC_BOOK_GOLD, "", SERIES_EXTRAS, FANTA_01),  # noqa: E501
    FantaSeriesInfo(Bt.CENSORSHIP_FIXES_AND_OTHER_CHANGES, "", SERIES_EXTRAS, FANTA_02),
    FantaSeriesInfo(Bt.HOW_TO_USE_THE_BARKS_READER, "", SERIES_EXTRAS, FANTA_02),
]
# fmt: on
