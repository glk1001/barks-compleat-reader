...
BARKS_TITLE_INFO: list[ComicBookInfo] = [
    ...
    ComicBookInfo(Titles.ONCE_UPON_A_CARNIVAL, False, Issues.CS, 279, 12, 1963, 24, 6, 1963),
    ...
    ComicBookInfo(Titles.BUBBLEWEIGHT_CHAMP, False, Issues.CS, 282, 3, 1964, 6, 9, 1963),
    ...
    ComicBookInfo(Titles.DOOM_DIAMOND_THE, False, Issues.US, 70, 7, 1967, 19, 3, 1966),
