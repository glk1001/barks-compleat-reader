...
ONE_PAGER_LOCATIONS: dict[Titles, tuple[int, int, int]] = {
    ...
    # without re-baking breaks the FANTA_01 override page sequence). Small Fryers
    # and False Flattery are not printed in any published Fantagraphics volume.
    ...
    # The two FC 1184 Gyro cover gags (Barks art) - not printed in any published
    # Fantagraphics volume.
