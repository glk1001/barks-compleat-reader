...
BARKS_TITLE_INFO: list[ComicBookInfo] = [
    ...
    ComicBookInfo(Titles.TEMPER_TAMPERING, False, Issues.US, 7, 9, 1954, 26, 2, 1953),
    ComicBookInfo(Titles.DINER_DILEMMA, False, Issues.US, 7, 9, 1954, 26, 2, 1953),
...
ONE_PAGER_LOCATIONS: dict[Titles, tuple[int, int, int]] = {
    ...
    Titles.TEMPER_TAMPERING: (12, 106, 35),
    Titles.DINER_DILEMMA: (12, 107, 36),
