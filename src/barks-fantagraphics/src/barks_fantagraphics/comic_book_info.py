...
# Every cover title, in BARKS_COVERS (bibliography) order. Covers are assigned
# titles synthesized from their issue (see barks_covers.get_cover_title_str);
# like one-pagers they sit outside the chronological story sequence, so the
# submitted-order check and chrono year lists exempt them.
