...
class Downloader:
    ...
    def __init__(self, cpi_db_path: Path | None = None) -> None:
        self._db_path: Path = cpi_db_path if cpi_db_path else self.THIS_DIR / "cpi.db"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Download latest cpi data.")
    parser.add_argument("db_path", type=Path, help="The path to cpi database.")
    args = parser.parse_args()

    Downloader(args.db_path).update()
