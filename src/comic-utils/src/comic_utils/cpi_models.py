...
class Series(BaseObject):
    ...
    def get_index_by_date(self, date: date, period_type="annual"):
        ...
        try:
            ...
            raise CPIObjectDoesNotExist(f"Index of {period_type} type for {date} does not exist")
...
class SeriesList(list):
    ...
    def get(
        ...
        try:
            ...
            raise CPIObjectDoesNotExist(f"Seasonality {seasonally_adjusted} does not exist")
